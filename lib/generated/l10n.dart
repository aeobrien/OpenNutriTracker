...
class S {
  ...
  String get baseLabel {
    return Intl.message('base', name: 'baseLabel', desc: '', args: []);
  }

  /// `earned`
  String get earnedLabel {
    return Intl.message('earned', name: 'earnedLabel', desc: '', args: []);
  }

  /// `eaten`
  String get eatenLabel {
    return Intl.message('eaten', name: 'eatenLabel', desc: '', args: []);
  }

  /// `over target`
  String get overTargetLabel {
    return Intl.message(
      'over target',
      name: 'overTargetLabel',
      desc: '',
      args: [],
    );
  }

  /// `This week: {amount} kcal under target`
  String weeklyUnderLabel(Object amount) {
    return Intl.message(
      'This week: $amount kcal under target',
      name: 'weeklyUnderLabel',
      desc: '',
      args: [amount],
    );
  }

  /// `This week: {amount} kcal over target`
  String weeklyOverLabel(Object amount) {
    return Intl.message(
      'This week: $amount kcal over target',
      name: 'weeklyOverLabel',
      desc: '',
      args: [amount],
    );
  }
